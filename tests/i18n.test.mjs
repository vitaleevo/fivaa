...
import { legalTranslations } from "../src/lib/i18n/sections/legal.ts";

const sections = { common: commonTranslations, home: homeTranslations, oradores: oradoresTranslations, forms: formsTranslations, contactos: contactosTranslations, programacao: programacaoTranslations, educacao: educacaoTranslations, sobre: sobreTranslations, parceiros: parceirosTranslations, legal: legalTranslations };
