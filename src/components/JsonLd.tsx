export function EventJsonLd() {
  const schema = {
    ...
    "@type": "Event",
    name: "FIVAA 2026 — Fórum & Festival Internacional da Valorização da Arte Africana",
    alternateName: "FIVAA Luanda 2026",
    description:
      "Fórum e Festival Internacional dedicado à promoção, valorização e desenvolvimento das indústrias criativas e da arte africana no emblemático Palácio de Ferro em Luanda, Angola.",
