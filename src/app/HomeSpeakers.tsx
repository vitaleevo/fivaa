    ...
    <section className="relative bg-green-dark py-28 md:py-32">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 text-center md:mb-16">
          <Badge className="border-white/20 bg-white/5 text-white/80">{t.oradores.homeBadge}</Badge>
          <h2 className="mt-6 font-montserrat text-4xl font-black text-white sm:text-5xl">
            {t.oradores.homeTitle}
          </h2>
          <p className="mt-4 text-white/60">{t.oradores.homeSubtitle}</p>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          >
            {t.oradores.homeLink} <span className="text-lg">→</span>
          </Link>
        </div>
      </div>
    </section>
